                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="col-md-12 border-bottom p-0">
                            <input name="nama_tiket" type="text" placeholder="Isi nama tiket..."
                                class="form-control p-0 border-0" value="{{ old('nama_tiket', $tiket->nama_tiket) }}"> </div>
                    </div>
                    <div class="form-group mb-4">
                        <label class="col-md-12 p-0">Harga Tiket</label>
                        <div class="col-md-12 border-bottom p-0">
                            <input name="harga_tiket" type="text" placeholder="Isi harga..."
                                class="form-control p-0 border-0" value="{{ old('harga_tiket', $tiket->harga_tiket) }}">
                        </div>
                    </div>
                    <div class="form-group mb-4">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="col-md-12 border-bottom p-0">
                            <input name="jam" type="text" placeholder="Contoh 19:00-00:00"
                                class="form-control p-0 border-0" value="{{ old('jam', $tiket->jam) }}">
                        </div>
                    </div>
                    <div class="form-group mb-4">
                        <div class="col-sm-12">
